...
def SaveFile():
    global newfilepath
    newfilepath = filedialog.asksaveasfilename(defaultextension=".rgt", filetypes=[("Tyros 4 files", "*.rgt")])
    if newfilepath:
        try:
...
def ConvertFile():
    ...
    if FileToConvert:
        ...
        with open(get_resource_path("tyros4.data"), 'rb') as f:
